...
<template>
  <view class="page-container">
    <view class="scrollable">
      <view class="form-unit-title"> 发票类型 </view>
        ...
        <view class="form-item flex-horizontal">
          ...
          <view class="form-item-input">
            <input
              ...
              type="text"
              cursor-spacing="16"
              placeholder="采购发票/销售发票"
              v-model="type"
            />
          </view>
        </view>
      </view>
      <view class="form-unit-title"> 发票关联 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 相关合同 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 相关客户 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
      ...
      <view class="form-unit-title"> 发票信息 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 发票代码 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 发票号码 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 开票日期 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
      ...
      <view class="form-unit-title"> 购买方 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 名称 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
      ...
      <view class="form-unit-title"> 销售方 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 名称 </view>
          <view class="form-item-input">
      ...
      <view class="form-unit-title"> 发票项目 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 项目名称 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 规格型号 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 单位 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 数量 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 单价 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 税率 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 税额 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
      ...
      <view class="form-unit-title"> 合计 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 价税合计 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
      ...
      <view class="form-unit-title"> 经办人 </view>
      <view class="form-container">
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 收款人 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 复核 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
        ...
        <view class="form-item flex-horizontal">
          <view class="form-item-label"> 开票人 </view>
          <view class="form-item-input">
            <input
              class="form-input"
              type="text"
